...
export const LOGIN_ACTION = defineAction('LOGIN_ACTION', [ERROR, CLEAR_ERRORS, REQUEST, SUCCESS, AUTHORIZE]);
export const REGISTER_ACTION = defineAction('REGISTER_ACTION', [ERROR, CLEAR_ERRORS, REQUEST, SUCCESS]);
